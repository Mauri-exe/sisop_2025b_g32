...
$ make test
=========================================
  FISOPFS - Tests de Operaciones de FS   
=========================================

▶ Ejecutando test: filecreate
[debug] fisopfs_getattr - path: /.Trash
[debug] fisopfs_getattr - path: /.Trash-1000
== Test 1: Crear archivo vacío ==
[debug] fisopfs_getattr - path: /test1.txt
[debug] fisopfs_create - path: /test1.txt
[debug] fisopfs_getattr - path: /test1.txt
  Archivo vacío creado correctamente
== Test 2: Crear archivo con contenido ==
[debug] fisopfs_getattr - path: /test2.txt
[debug] fisopfs_create - path: /test2.txt
[debug] fisopfs_getattr - path: /test2.txt
[debug] fisopfs_write - path: /test2.txt, offset: 0, size: 5
[debug] fisopfs_getattr - path: /test2.txt
  Archivo con contenido creado correctamente
== Test 3: Crear archivo que ya existe (touch no debe modificarlo) ==
  Archivo existente no se modificó
== Test 4: Crear archivo en subdirectorio ==
[debug] fisopfs_getattr - path: /subdir
[debug] fisopfs_mkdir - path: /subdir
[debug] fisopfs_getattr - path: /subdir
[debug] fisopfs_getattr - path: /subdir/nested.txt
[debug] fisopfs_create - path: /subdir/nested.txt
[debug] fisopfs_getattr - path: /subdir/nested.txt
[debug] fisopfs_write - path: /subdir/nested.txt, offset: 0, size: 4
[debug] fisopfs_getattr - path: /subdir/nested.txt
  Archivo creado en subdirectorio correctamente
== Test 5: Crear muchos archivos (1..50) ==
[debug] fisopfs_getattr - path: /file_1
[debug] fisopfs_create - path: /file_1
[debug] fisopfs_getattr - path: /file_1
[debug] fisopfs_write - path: /file_1, offset: 0, size: 2
...
[debug] fisopfs_getattr - path: /file_49
[debug] fisopfs_getattr - path: /file_50
  50 archivos creados y verificados correctamente
  PASÓ

▶ Ejecutando test: filerw
[debug] fisopfs_getattr - path: /.Trash
[debug] fisopfs_getattr - path: /.Trash-1000
== Test 1: Escribir y leer archivo simple ==
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_create - path: /test_rw.txt
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_write - path: /test_rw.txt, offset: 0, size: 4
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_read - path: /test_rw.txt, offset: 0, size: 4096
  Escritura y lectura simple funcionan
== Test 2: Sobrescribir contenido (truncate + write) ==
[debug] fisopfs_truncate - /test_rw.txt -> 0
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_write - path: /test_rw.txt, offset: 0, size: 6
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_read - path: /test_rw.txt, offset: 0, size: 4096
  Overwrite funciona correctamente
== Test 3: Append (escritura con offset automático) ==
[debug] fisopfs_write - path: /test_rw.txt, offset: 6, size: 3
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_read - path: /test_rw.txt, offset: 0, size: 4096
  Append funciona correctamente
== Test 4: Leer parcialmente (offsets de read) ==
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_read - path: /test_rw.txt, offset: 0, size: 4096
  Read parcial funciona
== Test 5: Escribir en el medio del archivo (write con offset) ==
[debug] fisopfs_write - path: /test_rw.txt, offset: 3, size: 1
[debug] fisopfs_write - path: /test_rw.txt, offset: 4, size: 1
[debug] fisopfs_write - path: /test_rw.txt, offset: 5, size: 1
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_read - path: /test_rw.txt, offset: 0, size: 4096
  Write con offset funciona correctamente
== Test 6: Escribir más allá del tamaño actual (expansión con holes) ==
[debug] fisopfs_write - path: /test_rw.txt, offset: 20, size: 1
[debug] fisopfs_write - path: /test_rw.txt, offset: 21, size: 1
[debug] fisopfs_write - path: /test_rw.txt, offset: 22, size: 1
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_read - path: /test_rw.txt, offset: 0, size: 4096
  Expansión con holes funciona correctamente
== Test 7: Leer más allá del tamaño (read debe truncar)==
[debug] fisopfs_getattr - path: /test_rw.txt
[debug] fisopfs_read - path: /test_rw.txt, offset: 0, size: 4096
  Read fuera de rango se trunca correctamente
  PASÓ

▶ Ejecutando test: mkdir
[debug] fisopfs_getattr - path: /.Trash
[debug] fisopfs_getattr - path: /.Trash-1000
[debug] fisopfs_getattr - path: /test_directory
[debug] fisopfs_mkdir - path: /test_directory
[debug] fisopfs_getattr - path: /test_directory
  PASÓ

▶ Ejecutando test: persist-root
[debug] fisopfs_getattr - path: /.Trash
[debug] fisopfs_getattr - path: /.Trash-1000
[debug] fisopfs_getattr - path: /
Test PASÓ: FS montado correctamente
  PASÓ

▶ Ejecutando test: persist-simple
Test FALLÓ: archivo no se encontró
 FALLÓ

▶ Ejecutando test: readdir
[debug] fisopfs_getattr - path: /.Trash
[debug] fisopfs_getattr - path: /.Trash-1000
[debug] fisopfs_getattr - path: /dir1
[debug] fisopfs_mkdir - path: /dir1
[debug] fisopfs_getattr - path: /dir1
[debug] fisopfs_getattr - path: /dir2
[debug] fisopfs_mkdir - path: /dir2
[debug] fisopfs_getattr - path: /dir2
[debug] fisopfs_getattr - path: /dir1/subdir
[debug] fisopfs_mkdir - path: /dir1/subdir
[debug] fisopfs_getattr - path: /dir1/subdir
[debug] fisopfs_getattr - path: /
[debug] fisopfs_readdir - path: /
[debug] fisopfs_getattr - path: /dir1
[debug] fisopfs_readdir - path: /dir1
  PASÓ

▶ Ejecutando test: rmdir
[debug] fisopfs_getattr - path: /.Trash
[debug] fisopfs_getattr - path: /.Trash-1000
[debug] fisopfs_getattr - path: /empty_dir
[debug] fisopfs_mkdir - path: /empty_dir
[debug] fisopfs_getattr - path: /empty_dir
[debug] fisopfs_getattr - path: /no_empty_dir
[debug] fisopfs_mkdir - path: /no_empty_dir
[debug] fisopfs_getattr - path: /no_empty_dir
[debug] fisopfs_getattr - path: /no_empty_dir/subdir
[debug] fisopfs_mkdir - path: /no_empty_dir/subdir
[debug] fisopfs_getattr - path: /no_empty_dir/subdir
[debug] fisopfs_rmdir - path: /empty_dir
[debug] fisopfs_getattr - path: /empty_dir
[debug] fisopfs_rmdir - path: /no_empty_dir
[debug] fisopfs_getattr - path: /no_empty_dir
[debug] fisopfs_rmdir - path: /no_empty_dir/subdir
[debug] fisopfs_rmdir - path: /no_empty_dir
[debug] fisopfs_getattr - path: /no_empty_dir
  PASÓ

▶ Ejecutando test: stat
== Preparando entorno ==
[debug] fisopfs_getattr - path: /.Trash
[debug] fisopfs_getattr - path: /.Trash-1000
== Test 1: UID/GID del usuario actual ==
[debug] fisopfs_getattr - path: /testfile.txt
[debug] fisopfs_create - path: /testfile.txt
[debug] fisopfs_getattr - path: /testfile.txt
[debug] fisopfs_write - path: /testfile.txt, offset: 0, size: 5
  UID correcto (getuid)
  GID correcto (getgid)
== Test 2: Permisos por defecto ==
  Permisos de archivo correctos (0644)
[debug] fisopfs_getattr - path: /testdir
[debug] fisopfs_mkdir - path: /testdir
[debug] fisopfs_getattr - path: /testdir
  Permisos de directorio correctos (0755)
== Test 3: Actualización de atime (access time) ==
[debug] fisopfs_getattr - path: /atime_test.txt
[debug] fisopfs_create - path: /atime_test.txt
[debug] fisopfs_getattr - path: /atime_test.txt
[debug] fisopfs_write - path: /atime_test.txt, offset: 0, size: 18
[debug] fisopfs_getattr - path: /atime_test.txt
[debug] fisopfs_getattr - path: /atime_test.txt
[debug] fisopfs_getattr - path: /atime_test.txt
[debug] fisopfs_read - path: /atime_test.txt, offset: 0, size: 4096
[debug] fisopfs_getattr - path: /atime_test.txt
  atime se actualiza correctamente al leer
== Test 4: Actualización de mtime/ctime (modification time) ==
[debug] fisopfs_getattr - path: /mtime_test.txt
[debug] fisopfs_create - path: /mtime_test.txt
[debug] fisopfs_getattr - path: /mtime_test.txt
[debug] fisopfs_write - path: /mtime_test.txt, offset: 0, size: 8
[debug] fisopfs_getattr - path: /mtime_test.txt
[debug] fisopfs_getattr - path: /mtime_test.txt
[debug] fisopfs_truncate - /mtime_test.txt -> 0
[debug] fisopfs_getattr - path: /mtime_test.txt
[debug] fisopfs_write - path: /mtime_test.txt, offset: 0, size: 11
[debug] fisopfs_getattr - path: /mtime_test.txt
  mtime se actualiza correctamente al escribir
  ctime se actualiza correctamente al modificar
== Test 5: Tamaño de archivo correcto ==
[debug] fisopfs_getattr - path: /size_test.txt
[debug] fisopfs_create - path: /size_test.txt
[debug] fisopfs_getattr - path: /size_test.txt
[debug] fisopfs_write - path: /size_test.txt, offset: 0, size: 10
[debug] fisopfs_getattr - path: /size_test.txt
  Tamaño de archivo correcto
[debug] fisopfs_getattr - path: /size_dir
[debug] fisopfs_mkdir - path: /size_dir
[debug] fisopfs_getattr - path: /size_dir
  Tamaño de directorio correcto (0)
  PASÓ

▶ Ejecutando test: unlink
== Preparando entorno ==
[debug] fisopfs_getattr - path: /.Trash
[debug] fisopfs_getattr - path: /.Trash-1000
== Test 1: Eliminar archivo existente ==
[debug] fisopfs_getattr - path: /file1.txt
[debug] fisopfs_create - path: /file1.txt
[debug] fisopfs_getattr - path: /file1.txt
[debug] fisopfs_write - path: /file1.txt, offset: 0, size: 5
[debug] fisopfs_getattr - path: /file1.txt
[debug] fisopfs_getattr - path: /file1.txt
  Archivo eliminado correctamente
== Test 2: Eliminar archivo que no existe ==
[debug] fisopfs_getattr - path: /noexiste.txt
[debug] fisopfs_getattr - path: /noexiste.txt
  rm devolvió error correctamente al no existir el archivo
== Test 3: Intentar eliminar un directorio con rm ==
[debug] fisopfs_getattr - path: /dir1
[debug] fisopfs_mkdir - path: /dir1
[debug] fisopfs_getattr - path: /dir1
  rm falló correctamente al intentar borrar un directorio
== Test 4: Crear → borrar → crear nuevamente ==
[debug] fisopfs_getattr - path: /reuse.txt
[debug] fisopfs_create - path: /reuse.txt
[debug] fisopfs_getattr - path: /reuse.txt
[debug] fisopfs_write - path: /reuse.txt, offset: 0, size: 4
[debug] fisopfs_getattr - path: /reuse.txt
[debug] fisopfs_getattr - path: /reuse.txt
[debug] fisopfs_create - path: /reuse.txt
[debug] fisopfs_getattr - path: /reuse.txt
[debug] fisopfs_write - path: /reuse.txt, offset: 0, size: 4
[debug] fisopfs_getattr - path: /reuse.txt
[debug] fisopfs_read - path: /reuse.txt, offset: 0, size: 4096
  Archivo recreado correctamente después de rm
  PASÓ
...
Además de los tests automatizados, se realizaron pruebas manuales interactuando con el filesystem a través de la terminal. Estas pruebas demuestran el correcto funcionamiento de las operaciones implementadas en un entorno real.

#### Configuración inicial

**Compilación y montaje del filesystem:**

```bash
$ make clean && make
rm -rf  *.o core vgcore.* fisopfs
gcc -ggdb3 -O2 -Wall -std=c11 -Wno-unused-function -Wvla   -c -o fs.o fs.c
gcc -ggdb3 -O2 -Wall -std=c11 -Wno-unused-function -Wvla   -c -o dir.o dir.c
gcc -ggdb3 -O2 -Wall -std=c11 -Wno-unused-function -Wvla fisopfs.c fs.o dir.o \
    -I/usr/include/fuse -D_FILE_OFFSET_BITS=64 -lfuse -pthread -o fisopfs

$ mkdir prueba
$ ./fisopfs prueba/ --filedisk nuevo_disco.fisopfs
$ mount | grep fisopfs
/dev/sda7 on /fisopfs type ext4 (rw,relatime)
/fisopfs/fisopfs on /fisopfs/prueba type fuse.fisopfs (rw,nosuid,nodev,relatime,user_id=0,group_id=0)
/fisopfs/fisopfs on /fisopfs/prueba type fuse.fisopfs (rw,nosuid,nodev,relatime,user_id=0,group_id=0)
```
...
$ ls -al
total 4
drwxr-xr-x 2 root   root      0 Nov 10 16:22 .
drwxrwxr-x 4 ubuntu ubuntu 4096 Nov 10 16:21 ..
```
---

#### Prueba 1: Creación y listado de directorios

**Comandos ejecutados en la segunda terminal:**

```bash
$ mkdir documentos
$ mkdir imagenes
$ ls  # Chequeo si se creo correctamente
documentos  imagenes
$ mkdir documentos/importante
$ cd documentos # Chequeo si se creo correctamente
$ ls 
importante
...
**Análisis:** 
- Los directorios se crean con permisos `0755` (rwxr-xr-x) por defecto
- El kernel llama a `getattr()` antes y después de `mkdir()` para validar la operación
- Los subdirectorios (como `/documentos/importante`) se crean correctamente

---

#### Prueba 2: Obtención de metadatos con `stat`
...
Device: 0,118	Inode: 2           Links: 2
Access: (0755/drwxr-xr-x)  Uid: (    0/    root)   Gid: (    0/    root)
Access: 2025-11-10 16:34:19.000000000 +0000
Modify: 2025-11-10 16:34:19.000000000 +0000
Change: 2025-11-10 16:34:19.000000000 +0000
 Birth: -
```

**Análisis:**
- **Tipo:** Directorio detectado correctamente
- **Permisos:** 0755 (rwxr-xr-x) asignados por defecto en `fs_create_node()`
- **Owner:** UID 0 (root) y GID 0 (root) correctos según el usuario que ejecuta
- **Timestamps:** Los tres timestamps (atime, mtime, ctime) se inicializan al momento de creación
- **Links:** 2 enlaces (el directorio en sí mismo `.` y su referencia desde el padre `..`)
- **Size:** 0 bytes (los directorios tienen tamaño 0 en nuestra implementación)

---

#### Prueba 3: Validación de eliminación de directorios

**Test 3.1: Intentar borrar directorio no vacío (debe fallar)**

```bash
$ rmdir documentos 
rmdir: failed to remove 'documentos': Directory not empty
```

**Análisis:** No se pudo eliminar el directorio porque la función `dir_remove()` detecta que `node->child_count > 0` y retorna el código de error **`-ENOTEMPTY`**

---

**Test 3.2: Eliminación correcta (hijo primero, luego padre)**

```bash
$ rmdir documentos/importante/
$ rmdir documentos 
$ ls  # Chequeo si se elimino correctamente el directorio imagenes
imagenes
```
...
**Análisis:**
- El subdirectorio `importante` se elimina correctamente (estaba vacío)
- Luego el padre `documentos` se elimina correctamente (ahora está vacío)
- Al listar la raíz, solo queda `imagenes` (el directorio `documentos` ya no existe)

---

#### Prueba 4: Creación de archivos y escritura (`touch`)

**Objetivo:** Verificar que el filesystem permite crear archivos correctamente mediante la operación `create`.
...
- Creación del archivo: El archivo prueba.txt se crea correctamente dentro del filesystem FUSE.
- Escritura: El comando echo "hola" > prueba.txt funciona y escribe en el archivo correctamente.

#### Prueba 5: Eliminacion de archivos 
**Objetivo:** Verificar que el filesystem permite eliminar archivos correctamente mediante la operación `remove`.
...
**Análisis:**
El archivo prueba.txt existía inicialmente en el directorio de montaje.
El comando rm se ejecutó sin mensajes de error, lo que indica que la llamada FUSE unlink() fue implementada y manejada correctamente.
El segundo ls muestra el directorio vacío, verificando que la entrada fue eliminada del árbol de directorios.

#### Prueba 6: Lectura parcial (offset + tamaño)
**Objetivo:** Verificar que Read() maneja correctamente offset y tamaño de lectura.
**Comandos utilizados**
```bash
$ echo "ABCDEFGH" > lectura2.txt
$ dd if=lectura2.txt bs=1 skip=2 count=3 2>/dev/null
```

Output
   'CDE'

**Analisis:** Valida la lectura dando el resultado esperado por el buffer

### Prueba 7: Escritura incremental
```bash
$ echo "primera linea" > log.txt
$ echo "segunda linea" >> log.txt
$ echo "tercera linea" >> log.txt
$ cat log.txt
```
**Resultado:** 
```bash 
...
**Análisis:** Se verifica el append para un archivo.

### Prueba 8: Validación completa de estadísticas de archivos

Esta prueba valida que los metadatos de archivos se gestionen correctamente.

```bash
$ echo "contenido inicial" > testfile.txt
$ stat testfile.txt
```
...
```
  ...
  Tamaño: 18        	Bloques: 0          Bloque E/S: 4096   fichero regular
Device: 0,74	Inode: 2           Links: 1
Acceso: (0644/-rw-r--r--)  Uid: ( 1000/mauricio04)   Gid: ( 1000/mauricio04)
Acceso: 2025-11-23 02:08:55.000000000 -0300
Modificación: 2025-11-23 02:08:55.000000000 -0300
      Cambio: 2025-11-23 02:08:55.000000000 -0300
    Creación: -
```

**Análisis del test 8.1 - UID/GID:**
- `Uid: 1000` y `Gid: 1000` corresponden al usuario actual (`mauricio04`)
- Se inicializan con `getuid()` y `getgid()` en `fs_create_node()`

**Análisis del test 8.2 - Permisos de archivos:**
- Los archivos tienen permisos `0644` (`-rw-r--r--`)
- Asignados en `fs_create_node()` cuando `type == FILE_NODE`

**Análisis del test 8.3 - Tamaño del archivo:**
- `Tamaño: 18` bytes corresponde a "contenido inicial\n" (17 chars + newline)
- El tamaño se actualiza en `file_write()` cuando `offset + size > node->size`

**Test 8.4 - Actualización de atime (access time):**

```bash
$ stat testfile.txt | grep Acceso 
Acceso: (0644/-rw-r--r--)  Uid: ( 1000/mauricio04)   Gid: ( 1000/mauricio04)
Acceso: 2025-11-23 02:08:55.000000000 -0300
...
$ stat testfile.txt | grep Acceso  
Acceso: (0644/-rw-r--r--)  Uid: ( 1000/mauricio04)   Gid: ( 1000/mauricio04)
Acceso: 2025-11-23 02:17:36.000000000 -0300
```

**Análisis:** El `atime` se actualiza correctamente tras la lectura (`cat`). El tiempo pasó de `02:08:55` a `02:17:36`, confirmando que `file_read()` actualiza el timestamp:
```c
node->atime = time(NULL);  // Se actualiza tras memcpy
```

**Test 8.5 - Actualización de mtime/ctime (modification time):**

```bash
$ stat testfile.txt | grep -E "(Modificación|Cambio)"
Modificación: 2025-11-23 02:08:55.000000000 -0300
      Cambio: 2025-11-23 02:08:55.000000000 -0300

$ echo "modificado" > testfile.txt

$ stat testfile.txt | grep -E "(Modificación|Cambio)"
Modificación: 2025-11-23 02:20:05.000000000 -0300
      Cambio: 2025-11-23 02:20:05.000000000 -0300
```

**Análisis:** Tanto `mtime` como `ctime` se actualizan correctamente al modificar el contenido (de `02:08:55` a `02:20:05`). Implementado en `file_write()`:
```c
node->mtime = time(NULL);  // Última modificación del contenido
node->ctime = time(NULL);  // Último cambio de metadata (incluye tamaño)
```

#### Observacion sobre el comportamiento del kernel

**Llamadas múltiples a `getattr()`:**

Durante las pruebas se observó que el kernel de Linux realiza múltiples llamadas a `getattr()` para cada operación. Por ejemplo, al ejecutar `mkdir /tmp/prueba_manual/documentos`:

1. `getattr("/documentos")` --> Verifica si ya existe
2. `mkdir("/documentos")` --> Crea el directorio
3. `getattr("/documentos")` --> Confirma que se creó correctamente

**Esto es comportamiento normal** del sistema operativo y demuestra que nuestro filesystem se integra correctamente con el kernel de Linux.
